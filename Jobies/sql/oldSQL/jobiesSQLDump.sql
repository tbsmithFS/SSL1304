...
# Database: JobiesDB
# Generation Time: 2013-04-28 01:58:30 +0000
# ************************************************************
...
CREATE TABLE `Jobs` (
  ...
  CONSTRAINT `Jobs_ibfk_2` FOREIGN KEY (`id`) REFERENCES `FollowedJobs` (`jobId`),
...
CREATE TABLE `Users` (
  ...
  CONSTRAINT `Users_ibfk_1` FOREIGN KEY (`emailId`) REFERENCES `Emails` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

LOCK TABLES `Users` WRITE;
/*!40000 ALTER TABLE `Users` DISABLE KEYS */;

INSERT INTO `Users` (`id`, `name`, `password`, `typeId`, `emailId`)
VALUES
	(1,'Alyssa','Alyssa',3,NULL),
	(2,'Zach','Zach',3,NULL);
